...
content:
  subtitle: ""
  text: |
    My full publication list is available on [Google Scholar](https://scholar.google.nl/citations?user=XkRvCC4AAAAJ&hl=en&oi=ao). Here are some selected works:
    ...
    *M Russo, A Celli, RC Baldeschi, F Fusco, D Haimovich, D Karamshuk, N Tax, ...*
    Advances in Neural Information Processing Systems 37 (NeurIPS), 2024.

    **On the convergence of loss and uncertainty-based active learning algorithms**
    *D Haimovich, D Karamshuk, F Linder, N Tax, M Vojnovic*
